...
@Repository
public class LabourInventoryFilterImpl implements LabourInventoryFilter {
	@Autowired
	private MongoTemplate mongoTemplate;

	@Override
	public List<LabourInventory> findLabourInventoryWithFilter(List<String> categoryList, String desc) {
...
//		}
		...
		return mongoTemplate.find(query, LabourInventory.class);
	}
	...
	public void updateCategory(String oldCategory, String newCategory) {
	    ...
	    mongoTemplate.updateMulti(query, update, LabourInventory.class);
	}
